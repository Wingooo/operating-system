...
int main(int argc,char **argv){
      ...
      sem_t *empty;
      sem_t *full;
      empty = sem_open("empty",O_CREAT | O_RDWR,0667,20);
      full = sem_open("full",O_CREAT | O_RDWR,0667,0);
      
      //共享内存的初始化
      const char *name = "OS";
      int shm_fd;
      void *ptr;
      shm_fd = shm_open(name, O_CREAT | O_RDWR, 0667);
